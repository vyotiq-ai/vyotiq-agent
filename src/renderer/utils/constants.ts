...
export const KEYBOARD_SHORTCUTS = {
  ...
  toggleMetrics: { key: 'i', modifier: 'ctrl+shift', description: 'Toggle metrics dashboard' },
  toggleProblems: { key: 'm', modifier: 'ctrl+shift', description: 'Toggle problems panel' },
  toggleTerminal: { key: '`', modifier: 'ctrl', description: 'Toggle terminal' },
  toggleOutput: { key: 'u', modifier: 'ctrl+shift', description: 'Toggle output panel' },
  toggleDebugConsole: { key: 'y', modifier: 'ctrl+shift', description: 'Toggle debug console' },

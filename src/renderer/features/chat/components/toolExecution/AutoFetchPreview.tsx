...
import { ChevronRight, ExternalLink, Globe, Zap } from 'lucide-react';
    ...
    <div className="ml-5 mt-1.5 mb-2 rounded-md overflow-hidden border border-[var(--color-border-subtle)]/30 bg-[var(--color-surface-editor)]">
      ...
      <div className="px-2.5 py-1.5 bg-[var(--color-surface-1)]/40 border-b border-[var(--color-border-subtle)]/20">
        <div className="flex items-center gap-2">
          <Zap size={10} className="text-[var(--color-accent-primary)]/70" />
        ...
        <div className="flex items-center gap-3 mt-0.5">
          <span className="text-[8px] px-1 py-0.5 bg-[var(--color-accent-primary)]/8 rounded-md text-[var(--color-accent-primary)]/70">
            {focus}
          </span>
      ...
      {sources && sources.length > 0 && (
        <div className="border-t border-[var(--color-border-subtle)]/20">
          ...
          >
            ...
            />
            <Globe size={9} className="text-[var(--color-text-dim)]/50" />

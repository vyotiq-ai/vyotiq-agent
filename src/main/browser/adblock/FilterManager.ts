 ...
 * These are major sites and CDNs that are essential for browsing
 */
const TRUSTED_DOMAINS: Set<string> = new Set([
  ...
  'akamaized.net',
  'cloudfront.net',
  // AI providers and ML platforms
  'anthropic.com',
  'openai.com',
  'deepseek.com',
  'huggingface.co',  // ML model hub - often false-positived by ad filters
  'hf.co',           // HuggingFace short domain
  'replicate.com',
  'together.ai',
  'groq.com',
  'mistral.ai',

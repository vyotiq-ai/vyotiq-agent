...
export const TOOL_CHAINING = _SECTIONS.TOOL_CHAINING.content as string;
...
export const TOOL_WORKFLOWS = TOOL_CHAINING;
export const TOOL_HINTS = TOOL_CHAINING;
export const TOOLS_REFERENCE = TOOL_CHAINING;
export const EDIT_TOOL_GUIDE = TOOL_CHAINING;
export const COMMON_TASKS = TOOL_CHAINING;

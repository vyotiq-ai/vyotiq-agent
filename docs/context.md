The agent should creates the plan and tasks in a beautifull and structured formeted .md file instead of the json.
- THe task's should be in a proper custom task list format.
- The plan should be in a proper custom detailed plan format with architecture and design and diagram and etc.





First, Analyze the entire codebase and complete implementations and understanding the current state of the app's codebase and layout and UI/UX and design and styling and etc.       
